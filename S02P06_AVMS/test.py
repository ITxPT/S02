...
print_result("examples/ConnectionMonitoringDelivery.xml", "xsd/ConnectionMonitoringDelivery.xsd")
print_result("examples/GeneralMessageDelivery.xml", "xsd/GeneralMessageDelivery.xsd")
print_result("examples/JourneyMonitoringDelivery.xml", "xsd/JourneyMonitoringDelivery.xsd")
