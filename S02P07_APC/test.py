...
print_result("examples/PassengerDoorCountDelivery.xml", "xsd/PassengerDoorCountDelivery.xsd")
print_result("examples/PassengerVehicleCountDelivery.xml", "xsd/PassengerVehicleCountDelivery.xsd")
print_result("examples/OccupancyDelivery.xml", "xsd/OccupancyDelivery.xsd")
