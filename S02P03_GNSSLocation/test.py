...
def validate_xml_against_xsd(xsd_filename, payload_path):
    ...
    if schema_element:
        ...
        is_valid = xsd.validate(read_xml(payload_path, lock_path))
        if not is_valid:
...
result = validate_xml_against_xsd("GNSSLocationDelivery.xsd", "GNSSLocationDelivery.xml")
if result:
    print("GNSSLocationDelivery.xml - Payload is valid according to schema.")

result = validate_xml_against_xsd("GNSSLocationDelivery.xsd", "GNSSLocationDelivery_Estimated.xml")
if result:
    print("GNSSLocationDelivery_Estimated.xml - Payload is valid according to schema.")

result = validate_xml_against_xsd("GNSSLocationDelivery.xsd", "GNSSLocationDelivery_NoFix.xml")
if result:
    print("GNSSLocationDelivery_NoFix.xml - Payload is valid according to schema.")
